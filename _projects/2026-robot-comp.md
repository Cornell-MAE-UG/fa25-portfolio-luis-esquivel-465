---
layout: project
title: Autonomous Block Collection Robot Competition
description: Design, manufacturing, and strategic development of an autonomous robot for competitive block collection and navigation.
technologies: [Arduino, Embedded Systems, Mechanical Design, CAD, Manufacturing, Robotics, Strategy Development]
image: /assets/images/robot-competition.png
permalink: /projects/2026-autonomous-robot-competition/
---
...
- Iterated on multiple arm and sled designs to improve block collection efficiency
- Assisted in CAD refinement and fabrication of PLA robot components
- Helped develop the passive “bulldozer-style” collection concept
- Contributed to overall robot movement and match strategy planning
- Participated in testing, debugging, and physical optimization of the robot
...
Additionally, the project improved my understanding of:
- Rapid prototyping and iterative design
- Mechanical integration with electronics and embedded systems
- Competition-based engineering strategy
- Troubleshooting motor performance and sensor reliability
- Collaborative engineering design workflows

## Key Results
- Designed and manufactured a fully autonomous competition robot
